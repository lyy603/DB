...
/**
 * 作者：lyy on 2017/5/16 15:44
 */

public class ShowingListBehavior extends CoordinatorLayout.Behavior {

    final Rect mTempRect1 = new Rect();
    final Rect mTempRect2 = new Rect();

    public ShowingListBehavior(Context context, AttributeSet attrs) {
        super(context, attrs);
    }
